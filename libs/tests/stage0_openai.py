...
and the three ported functions from `wind/models/openai/chat.py` are named
...
from wind.metrics import MessageMetrics, RunMetrics
from wind.models.message import Message
from wind.models.response import ModelResponse
from wind.run.base import RunContext, RunStatus
from wind.run.messages import RunMessages
from wind.run.agent import RunInput, RunOutput

# your three ported functions — from openai/chat.py:313, :803, :976
from wind.models.openai.chat import format_message, parse_provider_response, get_metrics
