"""Stage 3 Half B smoke test: message assembly (`wind/agent/_messages.py`)
and run orchestration (`wind/agent/_run.py`, `wind/agent/_response.py`) built
...
from wind.agent._messages import get_run_messages, get_session_history_messages, get_system_message, get_user_message
from wind.agent._response import update_run_response
from wind.agent.agent import Agent
from wind.models.anthropic.claude import Claude
from wind.models.message import Message
from wind.models.openai.chat import OpenAIChat
from wind.models.response import ModelResponse
from wind.run.agent import RunOutput
from wind.run.base import RunStatus
from wind.run.messages import RunMessages
...
from wind.exceptions import StopAgentRun
