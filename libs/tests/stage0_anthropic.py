...
in `wind/models/anthropic/claude.py` (the skeleton called them
...
from wind.models.anthropic.claude import parse_provider_response, get_metrics
from wind.utils.models.claude import format_messages
